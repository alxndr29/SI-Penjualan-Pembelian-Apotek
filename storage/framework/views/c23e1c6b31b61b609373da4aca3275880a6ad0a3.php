    ...
    <div class="row">
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="jumlah-pembelian-produk" class="form-control" type="text" placeholder="Masukan Jumlah Produk" data-bs-original-title="" title="">
                    </div>
                    <hr class="mt-4 mb-4">
                    ...
                    <div class="my-2">
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            <div>
                                <p class="fw-light">Satuan</p>
                            </div>
                            <div>
                                <p class="fw-bolder" id="detail-produk-satuan">-</p>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between mt-3">
                            <div>
            ...
            <div class="row gy-2">
                ...
                <div class="col-12">
                    <a href="<?php echo e(url('konfigurasi/pelanggan')); ?>" target="_blank" class=" btn btn-light txt-dark btn-md me-3 w-100">Tambah Pelanggan</a>
                </div>
                <!-- <div class="col-6">
                    <button type="button" class="btn btn-outline-danger txt-dark btn-md me-3 w-100">Draft</button>
                </div> -->
                <div class="col-12">
                    <button class="btn btn-outline-warning txt-dark btn-md me-3 w-100" id="button-cancel">Cancel</button>
                </div>
                <div class="col-12">
                    <button class="btn btn-success btn-lg me-3 w-100" id="button-simpan-transaksi">Simpan Transaksi</button>
                </div>
            </div>
        </div>
        <div class="col-8">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Alx\Documents\apotek-paramel\resources\views/pages/transaksi/penjualan/buat-transaksi-baru.blade.php ENDPATH**/ ?>