		...
		<nav class="sidebar-main">
			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='landing-page' ? 'active' : ''); ?>" href="<?php echo e(route('landing-page')); ?>"><i data-feather="home"> </i><span>Dashboard</span></a></li>
                    <li class="sidebar-main-title">
                        <div>
                            <h6>Transaksi</h6>
                        </div>
...
<?php /**PATH C:\Users\Alx\Documents\apotek-paramel\resources\views/layouts/simple/sidebar.blade.php ENDPATH**/ ?>