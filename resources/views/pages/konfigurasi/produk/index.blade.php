                        ...
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('daftar-produk.destroy', $product->id) }}" method="POST">
                                            <a href="{{route('daftar-produk.show', $product->id)}}" class="btn btn-info btn-sm">Detail</a>
                                            <a href="{{route('daftar-produk.edit', $product->id)}}" class="btn btn-warning btn-sm">Edit</a>
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="modal-body">
            <div class="row gy-4">
                <div class="col-12">
                    ...
                    <input class="form-control form-control-lg" id="exampleFormControlInput1 " autofocus="true" name="name" placeholder="Masukan Nama Produk">
                </div>
                <div class="col-xl-6">
                ...
                <div class="col-12">
                    ...
                    <div class="input-group">
                        <input class="form-control" type="number" name="min_stock" placeholder="Masukan Batas Minimum Untuk Produk Ini" aria-label="Recipient's username"><span class="input-group-text">Item</span>
                    </div>
                </div>
                <div class="col-6">
                    <label class="form-label" for="Diskon">Keuntungan</label>
                    <div class="input-group">
                        <input class="form-control" type="number" name="keuntungan" placeholder="Masukan Besaran Keuntungan Untuk Produk Ini" aria-label="Recipient's username"><span class="input-group-text">%</span>
                    </div>
                </div>
                <div class="col-6">
                    <label class="form-label" for="Diskon">Diskon</label>
                    <div class="input-group">
                        <input class="form-control" type="number" name="diskon" placeholder="Masukan Diskon Untuk Produk Ini" aria-label="Recipient's username"><span class="input-group-text">%</span>
                    </div>
                </div>
            </div>
        </div>
