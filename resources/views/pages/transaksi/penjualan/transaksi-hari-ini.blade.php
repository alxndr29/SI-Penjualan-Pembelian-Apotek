            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="mb-4"> Rp. {{number_format($totalPendapatan,0,',','.') }}
                            <h6 class="text-success">+ PPN {{number_format($totalPendapatan * 10 /100,0,',','.') }}</h6>
                        </h3>
                        ...
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right;" class="text-success">{{number_format($totalKeuntungan,0,',','.') ." (". $item->keuntungan."%)"}}</td>
                                    <td style="text-align:right;" class="text-danger">- {{number_format($totalDiskon,0,',','.')." (". $item->diskon."%)"}}</td>
                                    <td style="text-align:right;">{{number_format($item->harga * $item->jumlah + $totalKeuntungan - $totalDiskon,0,',','.') }}</td>
                                </tr>
                                @endforeach
